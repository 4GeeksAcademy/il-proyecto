		...
		<Container fluid className="container-landingpage">				
				<Row className="align-items-center">
					...
					<div className="d-flex flex-column align-items-center">
						<img src={`${process.env.FIREBASE_URL}/Home%2Flanding1.png?alt=media&token=e2f9a180-4252-490e-b050-295af756c1e9`}alt="Image 1" className="img-fluid  image-top-left-container1" />
						<img src={`${process.env.FIREBASE_URL}/Home%2Fsad.png?alt=media&token=307f6133-f77f-4404-98b1-5a10de5ecf5d`} alt="Image 2" className="img-fluid image-bottom-left-container1" />
					</div>
					</Col>
					...
					<Col xs={1} md={3} >
					<div className="d-flex flex-column align-items-center">
                    	<img src={`${process.env.FIREBASE_URL}/Home%2Fskate.png?alt=media&token=28f0e303-9cc8-468d-83ec-1f1d593cb91a`} alt="Image 3" className="img-fluid image-top-right-container1" />
                    	<img src={`${process.env.FIREBASE_URL}/Home%2Femotions.png?alt=media&token=3d93a047-9250-4c1c-aae9-d2ae74f1ff61`} alt="Image 4" className="img-fluid image-bottom-right-container1" />
                	</div>
					</Col>
				</Row>
				<CallToAction
				...
				<Row className="third-container-landingpage" >
					...
					<Col xs={12} sm="auto" md={4} className="d-flex justify-content-center align-items-center" >
						<div className="d-flex flex-column align-items-center">
							<img src={`${process.env.FIREBASE_URL}/Home%2Fphotos.png?alt=media&token=3d8d7c93-7121-4455-9199-b4bae6247dd4`} alt="Image 5" className="img-fluid image-third-container-landingpage" />
						</div>	
					</Col>
				</Row>						
				<Row className="fourth-container-landingpage">				
					<Col xs={12} md={3} className="d-flex justify-content-center align-items-center" >
						<div className="d-flex flex-column align-items-center">
							<img src={`${process.env.FIREBASE_URL}/Home%2Froad.png?alt=media&token=9f47e6d8-cc99-4112-ae69-bb4d150b03d1`} alt="Image 5" className="img-fluid image-fourth-container-landingpage" />	
						</div>
					</Col>
					...
					<Col xs={12} md={1} className="d-flex justify-content-center align-items-center" >
						<div className="d-flex flex-column align-items-center three-images-landing-page">
							<img src={`${process.env.FIREBASE_URL}/Home%2Fhappy.png?alt=media&token=a9a6dff6-8fe4-4d48-a61c-dbea526616df`} alt="Image 5" className="img-fluid image-happy-fiveth-container-landingpage" />	
							<img src={`${process.env.FIREBASE_URL}/Home%2Fserious.png?alt=media&token=56bdb012-834d-4a9b-87f1-6f5885f4edc2`} alt="Image 5" className="img-fluid image-serious-fiveth-container-landingpage" />	
							<img src={`${process.env.FIREBASE_URL}/Home%2Fangry.png?alt=media&token=648f3a16-beb6-49f0-a9cd-34d4dabc8584`} alt="Image 5" className="img-fluid image-angry-fiveth-container-landingpage" />	
						</div>
					</Col>
				</Row>				
				<Row className="fiveth-container-landingpage" >
					...
					<Col xs={12} md={5} className="d-flex justify-content-center align-items-center" >
						<div className="d-flex flex-column align-items-center">
							<img src={`${process.env.FIREBASE_URL}/Home%2Fpills.png?alt=media&token=ba5f83fd-87ef-431b-98c3-56f17855f4ce`} alt="Image 5" className="img-fluid image-sixth-container-landingpage" />
						</div>			
					</Col>
				</Row>			
				<CallToAction
